...
<body>
    ...
    <section class="hero">
        <div class="contenido-hero">
            <h2 class="titulo">Diseno y Desarrollo Web <span>Freelancer<span /></h2>
    ...
    <main class="contenedor sombra">
        ...
        <div class="servicios"> <!--CTRL + D para seleccionar y modificar varias lineas a la vez-->

            <section class="servicio"> <!--Section es para agrupar contenido, utilizalo cuando se tenga un titulo-->
                <h3>Diseno Web</h3>
